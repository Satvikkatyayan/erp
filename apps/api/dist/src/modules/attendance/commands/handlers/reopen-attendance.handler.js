...
exports.ReopenAttendanceHandler = void 0;
...
let ReopenAttendanceHandler = class ReopenAttendanceHandler {
    ...
    async execute(command) {
        return this.prisma.$transaction(async (tx) => {
            ...
            const toState = client_1.MusterWorkflowStatus.REOPENED;
            ...
            this.eventBus.publish(new attendance_lifecycle_events_1.AttendanceLifecycleEvent('AttendanceReopened', command.correlationId, {
                musterId: command.musterId,
                actorId: command.actorId,
                fromState,
                toState,
...
exports.ReopenAttendanceHandler = ReopenAttendanceHandler;
exports.ReopenAttendanceHandler = ReopenAttendanceHandler = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService,
        attendance_state_machine_service_1.AttendanceStateMachine,
        event_bus_service_1.EventBusService])
], ReopenAttendanceHandler);
//# sourceMappingURL=reopen-attendance.handler.js.map