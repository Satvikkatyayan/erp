...
exports.ApproveCorrectionHandler = void 0;
...
let ApproveCorrectionHandler = class ApproveCorrectionHandler {
    ...
    async execute(command) {
        return this.prisma.$transaction(async (tx) => {
            ...
            this.eventBus.publish(new attendance_lifecycle_events_1.AttendanceLifecycleEvent('AttendanceCorrectionApproved', command.correlationId, {
                musterId: command.musterId,
                actorId: command.actorId,
                fromState,
                toState,
...
exports.ApproveCorrectionHandler = ApproveCorrectionHandler;
exports.ApproveCorrectionHandler = ApproveCorrectionHandler = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService,
        attendance_state_machine_service_1.AttendanceStateMachine,
        event_bus_service_1.EventBusService])
], ApproveCorrectionHandler);
//# sourceMappingURL=approve-correction.handler.js.map