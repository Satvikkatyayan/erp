...
import { RejectCorrectionCommand } from '../reject-correction.command';
export declare class RejectCorrectionHandler {
    private readonly prisma;
    private readonly stateMachine;
    private readonly eventBus;
    constructor(prisma: PrismaService, stateMachine: AttendanceStateMachine, eventBus: EventBusService);
    execute(command: RejectCorrectionCommand): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        shiftId: string | null;
...
//# sourceMappingURL=reject-correction.handler.d.ts.map