...
export declare class StartReviewHandler {
    private readonly prisma;
    private readonly stateMachine;
    private readonly eventBus;
    private readonly reviewService;
    constructor(prisma: PrismaService, stateMachine: AttendanceStateMachine, eventBus: EventBusService, reviewService: AttendanceReviewService);
    execute(command: StartReviewCommand): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        shiftId: string | null;
...
//# sourceMappingURL=start-review.handler.d.ts.map