...
exports.ValidateAttendanceHandler = void 0;
...
let ValidateAttendanceHandler = class ValidateAttendanceHandler {
    ...
    async execute(command) {
        return this.prisma.$transaction(async (tx) => {
            ...
            const toState = client_1.MusterWorkflowStatus.VALIDATED;
            ...
            this.eventBus.publish(new attendance_lifecycle_events_1.AttendanceLifecycleEvent('AttendanceValidated', command.correlationId, {
                musterId: command.musterId,
                actorId: command.actorId,
                fromState,
                toState,
...
exports.ValidateAttendanceHandler = ValidateAttendanceHandler;
exports.ValidateAttendanceHandler = ValidateAttendanceHandler = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService,
        attendance_state_machine_service_1.AttendanceStateMachine,
        event_bus_service_1.EventBusService])
], ValidateAttendanceHandler);
//# sourceMappingURL=validate-attendance.handler.js.map