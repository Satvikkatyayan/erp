...
import { ApproveCorrectionCommand } from '../approve-correction.command';
export declare class ApproveCorrectionHandler {
    private readonly prisma;
    private readonly stateMachine;
    private readonly eventBus;
    constructor(prisma: PrismaService, stateMachine: AttendanceStateMachine, eventBus: EventBusService);
    execute(command: ApproveCorrectionCommand): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        shiftId: string | null;
...
//# sourceMappingURL=approve-correction.handler.d.ts.map