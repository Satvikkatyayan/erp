...
exports.RequestCorrectionHandler = void 0;
...
let RequestCorrectionHandler = class RequestCorrectionHandler {
    ...
    async execute(command) {
        return this.prisma.$transaction(async (tx) => {
            ...
            const toState = client_1.MusterWorkflowStatus.CORRECTION_REQUESTED;
            ...
            this.eventBus.publish(new attendance_lifecycle_events_1.AttendanceLifecycleEvent('AttendanceCorrectionRequested', command.correlationId, {
                musterId: command.musterId,
                actorId: command.actorId,
                fromState,
                toState,
...
exports.RequestCorrectionHandler = RequestCorrectionHandler;
exports.RequestCorrectionHandler = RequestCorrectionHandler = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService,
        attendance_state_machine_service_1.AttendanceStateMachine,
        event_bus_service_1.EventBusService])
], RequestCorrectionHandler);
//# sourceMappingURL=request-correction.handler.js.map