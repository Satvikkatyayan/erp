...
export declare class AssignmentConflictDetector implements IExceptionDetector {
    readonly identifier = "AssignmentConflictDetector";
...
//# sourceMappingURL=assignment-conflict.detector.d.ts.map