...
export declare class OvertimeThresholdDetector implements IExceptionDetector {
    readonly identifier = "OvertimeThresholdDetector";
...
//# sourceMappingURL=overtime-threshold.detector.d.ts.map