...
let ApprovalEngineService = class ApprovalEngineService {
    async getApprovalWorkflow(entityType, entityId) {
        return { levels: [], isComplete: true };
    }
};
exports.ApprovalEngineService = ApprovalEngineService;
exports.ApprovalEngineService = ApprovalEngineService = __decorate([
